/* ── detik AI Floating Widget — Tom Lembong scenario ── */
(function () {
  ...
  fab.innerHTML = `
    <div id="detik-ai-panel">
      ...
      <div class="ai-greeting">
        Halo! Saya <strong>detik AI</strong>. Sedang banyak diperbincangkan hari ini soal kasus Tom Lembong. Mau saya bantu jelaskan?
        <div class="greet-sub">Pilih salah satu pertanyaan di bawah ini:</div>
      </div>

      <div class="ai-suggestions-list">
        <button class="ai-sug-card enabled" data-q="Siapa Tom Lembong dan kenapa ia jadi tersangka?">
          <span class="sug-icon">›</span>
          <span>Siapa Tom Lembong dan kenapa ia jadi tersangka?</span>
        </button>
        <button class="ai-sug-card disabled" disabled>
          <span class="sug-icon">›</span>
          <span>
            Kasus korupsi gula ini sebetulnya soal apa?
        ...
        <button class="ai-sug-card disabled" disabled>
          <span class="sug-icon">›</span>
          <span>
            Kenapa banyak orang dan ekonom bela Tom Lembong?
            <div class="ai-disabled-hint">demo terkunci</div>
          </span>
        </button>
        <button class="ai-sug-card disabled" disabled>
          <span class="sug-icon">›</span>
          <span>
            Apa yang terjadi di sidang kemarin?
            <div class="ai-disabled-hint">demo terkunci</div>
          </span>
        </button>
      </div>
  ...
  document.querySelectorAll('.ai-sug-card.enabled').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      sessionStorage.setItem('detik_ai_scenario', 'tom_lembong');
      sessionStorage.setItem('detik_ai_first_query', q);
      window.location.href = 'ai-chat-tom.html';
    });
  });
